...
<body class="d-flex h-100 text-center text-bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main class="px-3">
            <h1>Gestion de Citas e Inventario.</h1>
            <p class="lead">Al renovar el registro de implementos necesarios para el consumidor, se agiliza la
                identificación, seguimiento y control de los productos.</p>
        </main>
