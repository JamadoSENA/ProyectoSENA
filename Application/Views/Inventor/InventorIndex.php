        ...
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Estimado Inventarista: </h5>
                        <p class="card-text">Tienes la oportunidad de gestionar las medicinas con sus respectivos
                        ...
                        <a href="InventorMedicinas.php" class="btn btn-primary">¡Empezar!</a>
                    </div>
