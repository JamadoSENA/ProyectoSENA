            ...
            <div class="col py-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <h5 class="card-title" style="margin-top:8px">Tabla Medicamentos</h5>
                            </div>
                            <div class="col-6 text-end">
                                <a href="Create/Medicina.php" class="nav-link px-0 text-dark">
                    ...
                    <div class="card-footer text-muted">
                        Esta tabla muestra las medicinas disponibles.
                    </div>
                </div>
            </div>
        </div>
