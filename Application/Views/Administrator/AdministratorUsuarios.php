            ...
            <div class="col py-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <h5 class="card-title" style="margin-top:8px">Tabla Usuarios</h5>
                            </div>
                        </div>
                        <hr>
                        <div class="table-responsive">
                            <table id="tablaUsers" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th scope="col" style="text-align: center;"># de Documento</th>
                                ...
                                $sql = $conexion->query("SELECT users.*, roles.name 
                                                        FROM users 
                                                        JOIN roles ON users.fkIdRole = roles.idRole");

                                while ($resultado = $sql->fetch_assoc()){ 
                                ?>

                                    <tr>
                                        <td scope="row" style="text-align: center;"><?php echo $resultado['idUser'] ?>
                                        </td>
                                        <td scope="row" style="text-align: center;"><?php echo $resultado['nameU'] ?>
                                        </td>
                                        <td scope="row" style="text-align: center;"><?php echo $resultado['lastname'] ?>
                                        </td>
                                        ...
                                        <td scope="row" style="text-align: center;">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="Update/Usuario.php?idUser=<?php echo $resultado['idUser']?>"
                                                        class="dropdown-item">Actualizar</a></li>
                                                <li><a href="Details/Usuario.php?idUser=<?php echo $resultado['idUser']?>"
